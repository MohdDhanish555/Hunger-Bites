    ...
    <div id="main-wrapper">
        ...
        <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3><a href="./all_orders.php"  class="num-clr">All Orders </a>/ Manage</h3>
                </div>
            </div>
                                    ...
                                    <table id="myTable" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                ?>
                                                    <td>
                                                        <center><button type="button" class="btn btn-info pntr" style="font-weight:bold;"><span class="fa fa-bars" aria-hidden="true"> Dispatched</button></center>
                                                    </td>
                                                <?php
                                                }
                                                if ($status == "in process") { ?>
                                                    <td>
                                                        <center><button type="button" class="btn btn-warning pntr"><span class="fa fa-cog fa-spin" aria-hidden="true"></span>On the way!</button></center>
                                                    </td>
                                                <?php
                                                }
                                                if ($status == "closed") {
                                                ?>
                                                    <td>
                                                        <center><button type="button" class="btn btn-success pntr"><span class="fa fa-check-circle" aria-hidden="true"> Delivered</button></center>
                                                    </td>
                                                <?php
                                                }
                                                ?>
                                                ...
                                                ?>
                                                    <td>
                                                        <center><button type="button" class="btn btn-danger pntr"> <i class="fa fa-close"></i> Cancelled</button> </center>
                                                    </td>
                                                <?php
                                                }
                                                ?>
