                                            ...
                                            if (!mysqli_num_rows($query) > 0) {
                                                ...
                                                while ($rows = mysqli_fetch_array($query)) {
                                                    ...
                                                    echo ' <tr><td>' . $row['c_name'] . '</td>
																								...
																								<td>' . $rows['date'] . '</td>
																									 <td><a href="delete_restaurant.php?res_del=' . $rows['rs_id'] . '" class="btn btn-flat btn-addon btn-xs m-b-10"><span class="iconify" data-icon="ic:outline-cancel" style="color: #ef3b0e;" data-width="26" data-height="24"></span></a> 
																									 <a href="update_restaurant.php?res_upd=' . $rows['rs_id'] . '" class="btn btn-info btn-flat btn-addon btn-sm m-b-10 m-l-5">Manage</a>
																									</td></tr>';
                                                }
                                            }
