                    ...
                    <div class="col-lg-12">
                        <div class="card card-outline-primary">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="card p-30 hvr">
                                        <div class="media">
                                            <div class="media-left meida media-middle">
                                                <span><i class="fa fa-archive f-s-40 "></i></span>
                                            </div>
                                            <div class="media-body media-text-right">
                                                <h2 class="num-clr"><?php $sql = "select * from restaurant";
                                ...
                                <div class="col-md-3">
                                    <div class="card p-30 hvr">
                                        <div class="media">
                                            ...
                                            <div class="media-body media-text-right">
                                                <h2 class="num-clr"><?php $sql = "select * from dishes";
                                                    $result = mysqli_query($db, $sql);
                                                    $rws = mysqli_num_rows($result);
                                ...
                                <div class="col-md-3">
                                    <div class="card p-30 hvr">
                                        <div class="media">
                                            <div class="media-left meida media-middle">
                                                <span><i class="fa fa-user f-s-40 num-clr"></i></span>
                                            </div>
                                            <div class="media-body media-text-right">
                                                <h2 class="num-clr"><?php $sql = "select * from users";
                                                    $result = mysqli_query($db, $sql);
                                                    $rws = mysqli_num_rows($result);
                                ...
                                <div class="col-md-3">
                                    <div class="card p-30 hvr">
                                        <div class="media">
                                            ...
                                            <div class="media-body media-text-right">
                                                <h2 class="num-clr"><?php $sql = "select * from users_orders";
                                                    $result = mysqli_query($db, $sql);
                                                    $rws = mysqli_num_rows($result);
