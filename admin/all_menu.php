                                                ...
                                                while ($rows = mysqli_fetch_array($query)) {
                                                    ...
                                                    echo '<tr><td>' . $fetch['title'] . '</td>
																								...
																								<center><img src="Res_img/dishes/' . $rows['img'] . '" class="img-responsive  radius" style="max-height:100px;max-width:150px;" /></center>
																									 ...
																									 <td><a href="delete_menu.php?menu_del=' . $rows['d_id'] . '" class="btn  btn-flat btn-addon btn-xs m-b-10"><span class="iconify" data-icon="ic:outline-cancel" style="color: #ef3b0e;" data-width="26" data-height="24"></span></a> 
																									 <a href="update_menu.php?menu_upd=' . $rows['d_id'] . '" class="btn btn-info btn-flat btn-addon btn-sm m-b-10 m-l-5">Manage</a>
																									</td></tr>';
                                                }
                                            }
